            ...
            <div class="l-content">
                <div class="m-wrapper">
                    <div class="sec-login">
                        ...
                        <form action="{{ route('nurse.login') }}" method="POST" class="m-login__form">
                            @csrf
                            ...
                            <button class="c-btnsubmit" type="submit">ログイン</button>
                        </form>
                        <br />
