                            ...
                            <div class="m-mypage__form">
                                ...
                                <div class="m-boxprofile-item01">
                                    ...
                                    <div class="m-wrapper">
                                        ...
                                        {{-- Info --}}
                                        <form method="POST" action="{{ route('nurse.storeinfo') }}"
                                                        ...
                                                        <div class="m-wrapper">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="municipalities"
                                                                    name="municipalities"
                                                                    placeholder={{ $nurse->municipality ? $nurse->municipality : '入力してください' }}
                                                                        ...
                                                                        <div class="avatar-preview">
                                                                            <div class="imagePreview">
                                                                                @foreach ($images as $image)
                                                                                    @if ($image->image_type == 'nurse_avatar')
                                                                                        <img src="{{ $image->path }}"
                                                                                            alt="">
                                                                                    @endif
                                                                                @endforeach
                                        ...
                                        {{-- Way of working --}}
                                        <form method="POST" action="{{ route('nurse.storeWayOfWorking') }}">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                                                    ...
                                                    <div class="m-wrapper">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="occupation">職種</label> {{-- Occupation --}}
                                                            <div class="m-boxselect">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="expertise">専門性</label> {{-- Expertise --}}
                                                            <div class="m-boxselect">
                                                                <select id="expertise" name="expertise"
                                                                    class="m-seclect01" required>
                                                                    <option value="呼吸器"
                                                                        selected={{ $nurse->occupation == '呼吸器' ? true : false }}>
                                                                        呼吸器</option>
                                                                    <option value="循環器"
                                                                        selected={{ $nurse->occupation == '循環器' ? true : false }}>
                                                                        循環器</option>
                                                                    <option value="脳神経"
                                                                        selected={{ $nurse->occupation == '脳神経' ? true : false }}>
                                                                        脳神経</option>
                                                                    <option value="腎·泌尿器(透析)"
                                                                        selected={{ $nurse->occupation == '腎·泌尿器(透析)' ? true : false }}>
                                                                        腎·泌尿器(透析)</option>
                                                                    <option value="皮膚排泄"
                                                                        selected={{ $nurse->occupation == '皮膚排泄' ? true : false }}>
                                                                        皮膚排泄</option>
                                                                    <option value="精神"
                                                                        selected={{ $nurse->occupation == '精神' ? true : false }}>
                                                                        精神</option>
                                                                    <option value="小児"
                                                                        selected={{ $nurse->occupation == '小児' ? true : false }}>
                                                                        小児</option>
                                                                    <option value="救急"
                                                                        selected={{ $nurse->occupation == '救急' ? true : false }}>
                                                                        救急</option>
                                                                    <option value="ターミナル"
                                                                        selected={{ $nurse->occupation == 'ターミナル' ? true : false }}>
                                                                        ターミナル</option>
                                                                    <option value="感染症"
                                                                        selected={{ $nurse->occupation == '感染症' ? true : false }}>
                                                                        感染症</option>
                                                                    <option value="麻酔"
                                                                        selected={{ $nurse->occupation == '麻酔' ? true : false }}>
                                                                        麻酔</option>
                                                                    <option value="在宅/地域/家族"
                                                                        selected={{ $nurse->occupation == '在宅/地域/家族' ? true : false }}>
                                                                        在宅/地域/家族</option>
                                                                    <option value="災害"
                                                                        selected={{ $nurse->occupation == '災害' ? true : false }}>
                                                                        災害</option>
                                                                    <option value="難病"
                                                                        selected={{ $nurse->occupation == '難病' ? true : false }}>
                                                                        難病</option>
                                                                    <option value="その他"
                                                                        selected={{ $nurse->occupation == 'その他' ? true : false }}>
                                                                        その他</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="m-boxselect">
                                                                <select id="businesscontent" name="businesscontent"
                                                                    class="m-seclect01" required>
                                                                    <option value="" disabled>
                                                                        {{ old('desired_hourly_wage') ? old('desired_hourly_wage') : '選択してください' }}
                                                                    </option>
                                                                    ...
                                                                    <option value="同行 外出支援 : 買い物等">同行 外出支援 : 買い物等
                                                                    </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="m-boxselect">
                                                                <select id="wayofworking" name="wayofworking"
                                                                    class="m-seclect01" required>
                                                                    <option value="" disabled>
                                                                        {{ $nurse->job_method ? $nurse->job_method : '選択してください' }}
                                                                    </option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="m-boxselect">
                                                                <select id="qualification" name="qualification"
                                                                    ...
                                                                    <option value="ナースプラクティクショナー">ナースプラクティクショナー
                                                                    </option>
                                                        ...
                                                        <div class="form-textarea">
                                                            ...
                                                            {{-- Orther Qualification --}}
                                                            <div class="m-textarea">
                                                                <textarea id="qualificationsother" name="qualificationsother" placeholder='入力してください' required>
                                                                {{ $nurse->other_information ?? '' }}
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="standardtime"
                                                                name="standardtime"
                                                                value={{ old('desired_hourly_wage') ? old('desired_hourly_wage') : $nurse->desired_hourly_wage }}
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="wage" name="wage"
                                                                value={{ old('desired_holiday_hourly_wage') ? old('desired_holiday_hourly_wage') : $nurse->desired_holiday_hourly_wage }}
                                                                placeholder={{ '入力してください' }} required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="wageforhome" name="wageforhome"
                                                                value={{ $nurse->home_visit_hourly_wage }}
                                                                placeholder={{ old('home_visit_hourly_wage') ? old('home_visit_hourly_wage') : '入力してください' }}
                                                                required>
                                                        </div>
                                        ...
                                        {{-- Job history --}}
                                        <form method="POST" action="{{ route('nurse.storeJobHistory') }}">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                                                    ...
                                                    <div class="m-wrapper">
                                                        <div class="form-group">
                                                            ...
                                                            {{-- graduation_school --}}
                                                            <input type="text" id="oldschool"
                                                                name="graduation_school" placeholder="入力してください"
                                                                value={{ old('graduation_school') ? old('graduation_school') : $nurse->graduation_school }}>
                                                        </div>
                                                        <div class="m-boxprofile-item02">
                                                            <div class="m-wrapper">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="m-boxdate">
                                                                        <input type="date" id="datepicker"
                                                                            ...
                                                                            value={{ old('graduation_date') ? old('graduation_date') : $nurse->graduation_date }}
                                                                            placeholder='選択してください' class="m-border0"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-textarea form-textarea01">
                                                            <label for="other_information">その他（経歴や所属団体など）</label>
                                                            {{-- other_information --}}
                                                            <textarea id="other_information" name="other_information" placeholder="入力してください">{{ old('other_information') ? old('other_information') : $nurse->other_information }}</textarea>
                                                        </div>
                                                    </div>
                                        ...
                                        {{-- License --}}
                                        <form method="POST" action="{{ route('nurse.storeLicense') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                            ...
                                                            <div class="m-profilepicture m-boxprofile01">
                                                                ...
                                                                <div class="avatar-upload">
                                                                    ...
                                                                    <div class="avatar-preview">
                                                                        <div class="imagePreview">
                                                                            @foreach ($images as $image)
                                                                                @if ($image->image_type == 'nurse_license')
                                                                                    <img src="{{ $image->path }}">
                                                                                @endif
                                                                            @endforeach
                                                                        </div>
                                        ...
                                        {{-- Identity --}}
                                        <form method="POST" action="{{ route('nurse.storeIdentity') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                            ...
                                                            <div class="m-profilepicture m-boxprofile01">
                                                                ...
                                                                <div class="avatar-upload">
                                                                    ...
                                                                    <div class="avatar-preview">
                                                                        <div class="imagePreview">
                                                                            @foreach ($images as $image)
                                                                                @if ($image->image_type == 'nurse_identify')
                                                                                    <img src="{{ $image->path }}" />
                                                                                @endif
                                                                            @endforeach
                                                                        </div>
