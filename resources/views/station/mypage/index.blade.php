              ...
              <div class="m-blockprofile m-blockprofile01">
                ...
                <p class="m-mypage__text01">chokowaは派遣労働ではなく、有料職業紹介事業です。<br>
                  ...
                  <div class="form-group form-checkbox">
                    <label for="agree">
                      <input type="checkbox" id="agree" name="agree" class="m-agree" required>
                      <span class="checkmark"></span>
                      <a href="#" class="m-agreetext m-colorblue m-borderbottom">利用規約</a><span>に同意して登録をする</span>
                    </label>
                  </div>
              </div>
                        ...
                        <div class="m-boxprofile-item02">
                          ...
                          <div class="m-wrapper">
                            ...
                            <div class="form-group">
                                ...
                                <div class="m-boxdate">
                                  <input type="text" id="datepicker" name="dateofbirth" placeholder="選択してください" class="m-border0" required>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="phonenumber">電話番号<span class="m-required">必須</span></label>
                                <input type="number" id="phonenumber" name="phonenumber" class="m-seclect01" placeholder="入力してください" required>
                            </div>

                            <div class="form-group">
                              <label for="postcode">郵便番号<span class="m-required">必須</span></label>
                              <div class="m-boxselect">
                                <select id="postcode" name="postcode" class="m-seclect01" required>
...
{{-- {{dd($prefectures)}} --}}
                            <div class="form-group">
                              <label for="prefectures">都道府県<span class="m-required">必須</span></label>
                              <div class="m-boxselect">
                                <select id="prefectures" name="prefectures" class="m-seclect01" required>
                                  <option value="" disabled>選択してください</option>
                                  {{-- <option value="郵便番号">都道府県</option>
                                  <option value="郵便番号">都道府県</option> --}}
                                  {{-- {{
                            ...
                            <div class="form-group">
                              <label for="municipalities">市区町村<span class="m-required">必須</span></label>
                              <input type="text" id="municipalities" name="municipalities" placeholder="入力してください" required>
                            </div>

                            <div class="form-group">
                              <label for="afteraddress">番地以降<span class="m-required">必須</span></label>
                              <div class="m-boxselect">
                                <select id="afteraddress" name="afteraddress" class="m-seclect01" required>
                                  <option value="" disabled>選択してください</option>
                            ...
                            <div class="form-group">
                              ...
                              <div class="m-boxselect">
                                <select id="station" name="station" class="m-seclect01">
                                  <option value="" disabled>選択してください</option>
                            ...
                            <div class="form-group form-grouppicture">
                              <label>プロフィール写真<span class="m-required">必須</span></label>
                              ...
                              <div class="m-ruleupfile">
                                <div class="m-ruleupfile__content">
                                  ...
                                  <p class="m-dot">インカメラでの撮影<br><span class="txt-indent">を推奨しています。</span></p>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="m-boxprofile-item03">
                          <div class="m-wrapper">
                            <label for="selfintroduction" class="m-mypage__title03">自己紹介</label>
                            <div class="m-textprofile">
                              <textarea class="m-textprofile__content" name="selfintroduction" id="selfintroduction"></textarea>
                            </div>
                          </div>
                        </div>

                        <button class="c-btnsubmit m-btn01 m-btnprofile" type="button">登録する</button>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                        <h2 class="m-mypage__title01 m-mypage__title04">働き方<span class="m-required">必須</span></h2>
                        ...
                        <div class="m-wrapper">
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="occupation" name="occupation" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="expertise" name="expertise" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="businesscontent" name="businesscontent" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                                ...
                                <option value="移動支援 : 旅行やイベントなど">移動支援 : 旅行やイベントなど</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="wayofworking" name="wayofworking" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="qualification" name="qualification" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" id="standardtime" name="standardtime" placeholder="入力してください" required>
                          </div>

                          <div class="form-group">
                            <label for="wage">休日時給</label>
                            <input type="text" id="wage" name="wage" placeholder="入力してください" required>
                          </div>

                          <div class="form-group">
                            <label for="wageforhome">訪問診療時の時給</label>
                            <input type="text" id="wageforhome" name="wageforhome" placeholder="入力してください" required>
                          </div>

                          <button class="c-btnsubmit m-btn01 m-btnworking" type="button">登録する</button>
                    ...
                    <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                        ...
                        <div class="m-wrapper">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" id="oldschool" name="oldschool" placeholder="入力してください">
                          </div>

                          <div class="form-group">
                            <label for="graduationdate">卒業年月</label>
                            <div class="m-boxselect">
                              <select id="graduationdate" name="graduationdate" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                                <option value="卒業年月">卒業年月</option>
                                <option value="卒業年月">卒業年月</option>
                                <option value="卒業年月">卒業年月</option>
                                <option value="卒業年月">卒業年月</option>
                              </select>
                        ...
                        <button class="c-btnsubmit m-btn01 m-btnworking m-btnworking01" type="button">登録する</button>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                        <h2 class="m-mypage__title01 m-mypage__title04">振込口座<span class="m-required">必須</span></h2>

                          <div class="form-group">
                            <label for="financial">金融機関名</label>
                            <div class="m-boxselect">
                              <select id="financial" name="financial" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="branchname" name="branchname" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <div class="m-boxselect">
                              <select id="deposittype" name="deposittype" class="m-seclect01" required>
                                <option value="" disabled>選択してください</option>
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" id="accountnumber" name="accountnumber" placeholder="入力してください" required>
                          </div>

                          <div class="form-group">
                            <label for="accountname">口座名義(カナ)</label>
                            <input type="text" id="accountname" name="accountname" placeholder="入力してください" required>
                          </div>

                          <button class="c-btnsubmit m-btn01 m-btnworking m-btnworking02" type="button">登録する</button>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                        <h2 class="m-mypage__title01 m-mypage__title04">免許登録<span class="m-required">必須</span></h2>
                        ...
                        <div class="m-wrapper">
                          ...
                          <div class="form-group form-grouppicture form-grouppicture01">
                            <div class="m-profilepicture m-boxprofile01">
                              ...
                              <div class="avatar-upload">
                                <div class="avatar-edit">
                                    <input type="file" id="imageUpload01" class="imageUpload" accept=".png, .jpg, .jpeg">
                          ...
                          <div class="m-imgprofile">
                            <img src="{{ asset('assets/img/img_profile.jpg')}}" alt="岡山 花子">
                          </div>
                          <button class="c-btnsubmit m-btn01 m-btnworking m-btnworking03" type="button">登録する</button>
                  ...
                  <div class="form-group">
                    ...
                    <div class="m-blockprofile m-dropdow m-boxprofile-item02">
                      <h2 class="m-mypage__title01 m-mypage__title04">本人確認書類登録<span class="m-required">必須</span></h2>
                      ...
                      <div class="m-wrapper">
                        ...
                        <div class="form-group form-grouppicture form-grouppicture01">
                          <div class="m-profilepicture m-boxprofile01">
                            ...
                            <div class="avatar-upload">
                              <div class="avatar-edit">
                                  <input type="file" id="imageUpload02" class="imageUpload" accept=".png, .jpg, .jpeg">
                        ...
                        <button class="c-btnsubmit m-btn01 m-btnworking04" type="button">登録する</button>
